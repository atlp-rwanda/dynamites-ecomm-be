...
export const getallNotification = errorHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(200)
      .json({ msg: 'Notification retrieved successfully', notification });
  }
);
...
export const deleteallNotification = errorHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(200)
      .json({ msg: 'All notifications deleted successfully' });
  }
);
...
export const getvendorNotifications = errorHandler(
  async (req: Request, res: Response) => {
    ...
    return res
      .status(200)
      .json({ msg: 'Notifications retrieved successfully', notification });
  }
);
